Contributing to exobot-adapter-discord
======================

So you want to contribute to exobot-adapter-discord? Fantastic! Here's a brief overview on
how best to do so.
...
[create an issue](https://github.com/exoplay/exobot-adapter-discord/issues) before putting
...
1. [Fork the repository](https://github.com/exoplay/exobot-adapter-discord/fork_select) to
  your Github account.
...
exobot-adapter-discord is MIT licensed. See details in the LICENSE file. This is a very permissive
